...
<div class="card shadow w-50 bg-gradient-dark" style="border:none;">
           ...
           <br>
                <i><a href="stud_delete_proc.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
        ...
        &nbsp;&nbsp;&nbsp;
        <a href="stud_manage.php?id=<?= $id?>" class="btn btn-danger btn-icon-split btn-md">
        <span class="icon text-white-50">
